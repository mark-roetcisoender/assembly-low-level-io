Program written in Assembly which prompts the user for 10 numbers. The program utilizes macros to read and write integers via string processing rather than ReadInt
